...
Partial Class LoginForm
    ...
    Private Sub InitializeComponent()
        ...
        ' TextBox2
        ' 
        TextBox2.Location = New Point(162, 63)
        ...
        ' btnClear
        ' 
        btnClear.Location = New Point(19, 93)
        ...
        ' btnRegister
        ' 
        btnRegister.Location = New Point(110, 93)
        ...
        ' btnLogin
        ' 
        btnLogin.Location = New Point(201, 93)
